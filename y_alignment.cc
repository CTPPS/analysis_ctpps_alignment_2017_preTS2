...
int main()
{
	...
	vector<RPData> rpData = {
		{ "L_2_F",  23, "sector 45", (cfg.xangle == 150) ? 0.13 : 0.12, -41.97 },
		{ "L_1_F",   3, "sector 45", (cfg.xangle == 150) ? 0.14 : 0.13, -3.57 },
		{ "R_1_F", 103, "sector 56", (cfg.xangle == 150) ? 0.28 : 0.25, -2.75 },
		{ "R_2_F", 123, "sector 56", (cfg.xangle == 150) ? 0.28 : 0.24, -42.15 }
	};
