...
sectors.push("45"); s_labels.push("sector 45"); s_y_mins.push(-0.5); s_y_maxs.push(+0.5); s_y_cens.push(+0.008); s_rp_Ns.push("L_1_F"); s_rp_Fs.push("L_2_F");
sectors.push("56"); s_labels.push("sector 56"); s_y_mins.push(-0.5); s_y_maxs.push(+0.5); s_y_cens.push(-0.012); s_rp_Ns.push("R_1_F"); s_rp_Fs.push("R_2_F");
...
GShipout("al_vert_rel_cmp_method", hSkip=5mm, vSkip=1mm);
