...
config.x_alignment_meth_o.rp_L_2_F.x_min = 1.5
config.x_alignment_meth_o.rp_L_2_F.x_max = 6.

config.x_alignment_meth_o.rp_L_1_F.x_min = 1.5
config.x_alignment_meth_o.rp_L_1_F.x_max = 6.

config.x_alignment_meth_o.rp_R_1_F.x_min = 1.5
config.x_alignment_meth_o.rp_R_1_F.x_max = 6.

config.x_alignment_meth_o.rp_R_2_F.x_min = 1.5
config.x_alignment_meth_o.rp_R_2_F.x_max = 6.
